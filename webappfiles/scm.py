...
def plot_SCM(path):
    ...
    X_Waveform = f['A231_W'][300:]  # Skip the first 300 points
    Y_Waveform = f['A232_W'][300:]  # Skip the first 300 points
    Z_Waveform = f['A233_W'][300:]  # Skip the first 300 points
    verse_time = f['VERSE_TIME'][300:].values.flatten()  # Skip the first 300 points
