...
def draw_map():
    ...
    if last_active_drawing:
        ...
        if geometry and 'coordinates' in geometry:
            ...
            plot_EFD(pathskidibidi[0])
            print(polygon(coords, file_list[:-1]))
            # polygon_points = [(-180.0, -90.0), (180.0, -90.0), (180.0, 90.0), (-180.0, 90.0)]
        
            # [[-177.1875, 44.840291], [-177.1875, 63.704722], [-119.53125, 63.704722], [-119.53125, 44.840291], [-177.1875, 44.840291]]
